...
### AGP/Gradle/Kotlin 互換性マトリクス
| AGP | Gradle | Kotlin | Java | 備考 |
|-----|--------|--------|------|------|
| 8.1.x | 8.0+ | 1.9.0+ | 17 | Flutter 3.16+ |
| 8.2.x | 8.4+ | 1.9.22+ | 17 | Flutter 3.19推奨 |
| 8.3.x | 8.5+ | 2.0.0+ | 17 | 最新（2026年） |

> **重要:** AGP/Gradle/Kotlinはセットで互換性を確認する必要がある。
> 
> AGPを上げる場合 → Gradleも上げる → 必要に応じてKotlinも上げる
...
- [ ] 古いAPIを使っていない
- [ ] disposeを忘れていない
- [ ] ネイティブプラグイン導入後にビルドテストを実行した
- [ ] パッケージ導入前にChangelog/Issue確認した
